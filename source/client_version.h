...
public:
	...
	void clearItemsPath();
	void setMonstersPath(const FileName& dir);
	void clearMonstersPath();
	void setNpcsPath(const FileName& dir);
	void clearNpcsPath();
	...
	FileName getItemsPath() const;
	bool hasCustomItemsPath() const {
		return use_custom_items_path;
	}
	FileName getCustomItemsPath() const {
		return items_path;
	}
	FileName getMonstersPath() const;
	bool hasCustomMonstersPath() const {
		return use_custom_monsters_path;
	}
	FileName getCustomMonstersPath() const {
		return monsters_path;
	}
	FileName getNpcsPath() const;
	bool hasCustomNpcsPath() const {
		return use_custom_npcs_path;
	}
	FileName getCustomNpcsPath() const {
		return npcs_path;
	}
...
private:
	...
	bool use_custom_items_path;
	bool use_custom_monsters_path;
	bool use_custom_npcs_path;
