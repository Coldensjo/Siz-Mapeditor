...
public:
	...
	static bool loadAuxiliaryHouses(Map& map, const FileName& mapFile);
	static bool loadAuxiliarySpawns(Map& map, const FileName& mapFile);
	static bool loadAuxiliaryComments(Map& map, const FileName& mapFile);
...
protected:
	...
	bool loadSpawns(Map& map, TomlNode& doc);
	bool loadHouses(Map& map, const FileName& dir);
	bool loadHouses(Map& map, pugi::xml_document& doc);
	bool loadHouses(Map& map, TomlNode& doc);
	bool loadSpawnsFromTomlEntries(Map& map, TomlNode& spawnEntries);
	bool loadRegularSpawnTomlEntry(Map& map, TomlNode& spawnNode, int defaultSpawnTime, int maxSpawnRadius);
	...
	bool saveSpawns(Map& map, toml::table& rootTable);
	bool saveHouses(Map& map, const FileName& dir);
	bool saveHouses(Map& map, pugi::xml_document& doc);
	bool saveHouses(Map& map, toml::table& rootTable);
	bool loadComments(Map& map, const FileName& dir);
	bool loadComments(Map& map, pugi::xml_document& doc);
	bool saveComments(Map& map, const FileName& dir);
	bool saveComments(Map& map, pugi::xml_document& doc);
};
