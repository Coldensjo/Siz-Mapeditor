...
MainToolBar::MainToolBar(wxWindow* parent, wxAuiManager* manager) {
	...
	sizes_toolbar->AddTool(TOOLBAR_SIZES_2X2, wxEmptyString, size2_bitmap, wxNullBitmap, wxITEM_CHECK, "Size 2", wxEmptyString, NULL);
	sizes_toolbar->AddTool(TOOLBAR_SIZES_2, wxEmptyString, size3_bitmap, wxNullBitmap, wxITEM_CHECK, "Size 3", wxEmptyString, NULL);
	sizes_toolbar->AddTool(TOOLBAR_SIZES_3, wxEmptyString, size4_bitmap, wxNullBitmap, wxITEM_CHECK, "Size 4", wxEmptyString, NULL);
	sizes_toolbar->AddTool(TOOLBAR_SIZES_4, wxEmptyString, size5_bitmap, wxNullBitmap, wxITEM_CHECK, "Size 5", wxEmptyString, NULL);
	sizes_toolbar->AddTool(TOOLBAR_SIZES_5, wxEmptyString, size6_bitmap, wxNullBitmap, wxITEM_CHECK, "Size 6", wxEmptyString, NULL);
	sizes_toolbar->AddTool(TOOLBAR_SIZES_6, wxEmptyString, size7_bitmap, wxNullBitmap, wxITEM_CHECK, "Size 7", wxEmptyString, NULL);
	sizes_toolbar->AddTool(TOOLBAR_SIZES_7, wxEmptyString, size7_bitmap, wxNullBitmap, wxITEM_CHECK, "Size 8", wxEmptyString, NULL);
	...
	sizes_toolbar->ToggleTool(TOOLBAR_SIZES_2X2, false);
...
void MainToolBar::UpdateButtons() {
	...
	sizes_toolbar->EnableTool(TOOLBAR_SIZES_2X2, has_map);
...
void MainToolBar::UpdateBrushSize(BrushShape shape, int size) {
	...
	sizes_toolbar->ToggleTool(TOOLBAR_SIZES_2X2, size == GUI::BRUSH_SIZE_2X2);
